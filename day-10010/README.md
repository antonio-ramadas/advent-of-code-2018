...
You can't help but notice that the [device's opcodes](../day-01111) don't contain any flow control like jump instructions. The device's [manual](../day-01111) goes on to explain:
...
_What value is left in register 0_ when the background process halts?
