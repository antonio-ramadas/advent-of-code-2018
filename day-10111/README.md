...
The _immune system_ and the _infection_ each have an army made up of several _groups_; each _group_ consists of one or more identical _units_. The armies repeatedly fight until only one army has units remaining.
