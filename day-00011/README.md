...
_Strategy 1_: Find the guard that has the most minutes asleep. What minute does that guard spend asleep the most?
...
_Strategy 2_: Of all guards, which guard is most frequently asleep on the same minute?
